...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { description: @opportunity.description, location: @opportunity.location, status: @opportunity.status }
    end
  ...
  test "should update opportunity" do
    put :update, id: @opportunity, opportunity: { description: @opportunity.description, location: @opportunity.location, status: @opportunity.status }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
