...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { category: @work_order.category, description: @work_order.description, due: @work_order.due, status: @work_order.status }
    end
  ...
  test "should update work_order" do
    put :update, id: @work_order, work_order: { category: @work_order.category, description: @work_order.description, due: @work_order.due, status: @work_order.status }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
